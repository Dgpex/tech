      ...
      <div className="grid grid-cols-1 md:grid-cols-12 ">
        <div className="bg-primary md:col-span-4 p-10 text-white">
          ...
          <div className="flex items-center mt-5">
            <svg className="h-6 mr-2 text-indigo-600" fill="currentColor" version="1.1" id="Capa_1"
              xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
              viewBox="0 0 300.988 300.988" style={{ enableBackground: "new 0 0 300.988 300.988;" }} xmlSpace="preserve">
              <g>
        ...
        <form className="md:col-span-8 p-10">
          ...
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full px-3">
              ...
              <textarea id="grid-message" rows="10"
                className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" required></textarea>
            </div>
